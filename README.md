...
When any metric time on the display is a prime number, I highlight it in red. I'm crazy about primes. You can change this setting in the iOS Settings app, in the entry for netclock.
